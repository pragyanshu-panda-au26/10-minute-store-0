...
import DarkStoresView from "@/components/admin/DarkStoresView";
import { Menu } from "lucide-react";

export default function AdminDarkStoresPage() {
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="sticky top-0 z-30 flex items-center justify-between border-b border-slate-800 bg-slate-950/90 px-5 py-3.5 backdrop-blur-md">
          ...
          <h1 className="text-base font-black text-white">Dark Store Hub Management & Location Controls</h1>
        </header>
